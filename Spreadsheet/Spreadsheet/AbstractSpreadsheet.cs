...
namespace SS
{
    ...
    public abstract class AbstractSpreadsheet
    {
        ...
        /// checks through directdependents to see if start is contained - if it is throw circular exception
        /// if not, checks if cell was visited and if not recursively cells method again to check for cycles
        /// </summary>
